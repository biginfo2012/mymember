...
import { makeStyles, Tooltip, Typography, Button, IconButton } from "@material-ui/core";
...
const TemplatesList = (props) => {
  ...
  const { listoftemplates, mainFolderdata, subfolderdata, setdata, handleInsert } = props;
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div>
                    <Button
                      ...
                      size="small"
                      style={{ borderRadius: '8px', widht: "15px",  }}
