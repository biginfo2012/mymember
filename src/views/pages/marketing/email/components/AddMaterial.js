    ...
    <Fragment>
      ...
      >
        <Tooltip arrow title="Attach files max 30 at a time">
          <Button
            style={{ borderRadius: "24px", border: "2px solid #2796f3", background: "transparent" }}
            variant="contained"
            component="span"
            onClick={handleClickOpen}>
            <SnippetFolderIcon style={{color: "#2796f3"}}/>
            <span className="font-weight-bold mx-1" style={{ color: "#2796f3"}}>Material</span>
            <AddIcon style={{color: "#2796f3"}}/>
          </Button>
          {/*<IconButton*/}
          {/*  style={{ color: "#2796f3" }}*/}
          {/*  variant="contained"*/}
