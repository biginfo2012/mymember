...
import imageCard from "../../../../../../src/assets/img/pages/content-img-4.jpg"
import imageCard1 from "../../../../../../src/assets/img/pages/video-poster.jpg"
...
const SimplePdfViewer = (props) => {
  ...
  return (
    ...
    <div className="col-12" style={{
      ...
      <div className="my-2">
        <DropzoneArea
          dropzoneText="Drag and drop your files here! Supported Files: PDF,Word,JPEG,PNG"
      ...
      <div className='d-flex justify-content-between'>
        <div><h6 style={{ font: '18px' }}> <b>Select a template</b></h6></div>
      ...
      <div className='d-flex justify-content-between'>
        <div>
          <div className={classes.styleCards} style={{ backgroundImage: `url(${imageCard})` }}></div>
          <h6 className={classes.styleText} >Blank</h6>
        </div>
        <div>
          <div className={classes.styleCards} style={{ backgroundImage: `url(${imageCard1})`, backgroundSize: "cover" }}></div>
          <h6 className={classes.styleText} >Test16565</h6>
        ...
        <div>
          <div className={classes.styleCards} style={{ backgroundImage: `url(${imageCard1})` }}></div>
          <h6 className={classes.styleText} >Blank</h6>

        </div>
        <div>
          <div className={classes.styleCards} style={{ backgroundImage: `url(${imageCard})` }}></div>
          <h6 className={classes.styleText} >demo222</h6>
