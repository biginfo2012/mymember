...
import { GET_FUNNEL, GET_SINGLE_FUNNLE } from "../../../../redux/actions/form-builder/index"
      ...
      <div>
        ...
        <Grid container spacing={2}>
          <Grid item lg="6" md="6" sm="6">
            ...
            >
              {funnels.length > 0 && funnels?.map((item, i) => {
                return (
...
export default connect(mapstateprops, { GET_FUNNEL })(Digitalforms);
