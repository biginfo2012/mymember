import { Card, MenuItem, Select, Button, Typography } from "@material-ui/core";
import React, { useState } from 'react'
import {
    Col, FormGroup, Label, Row, TabContent, TabPane, Nav,
    NavItem, NavLink, CardHeader, CardBody, CardTitle, CardText, CardFooter, Table
} from 'reactstrap'
                                ...
                                <Col sm="6">
                                    <Card>
                                        <CardHeader className="d-flex justify-content-between p-1">
                                            ...
                                            <div>
                                                <Button className="btn text-white" style={{ background: "#1BA6E1", color: "3fff", borderRadius: "10px" }}>Edit</Button>
                                                <Button className="btn text-white"
                                                    style={{ background: "#1BA6E1", color: "3fff", borderRadius: "10px", marginLeft: "5px" }}
                                        ...
                                        <CardBody>
                                            <div className="d-flex justify-content-between">
                                                <div className="change">
                                                    <h4>Status: Active</h4>
                                                    <Button className="btn btn-danger text-white">Deactivate</Button>
                                                </div>
                                                <CircularProgress
                                                    variant="determinate"
                                                    value={10}
