...
const MissCallTable = (props) => {
  ...
  const { rowdata, GetMoreNewData, datas, studentType, tillDate, Tabsvalue, loading } = props;
  ...
  useEffect(() => {
    if (studentType === "All") {
      GetMoreNewData(pageNumber, rowsPerPage, datas);
    } else {
      GetMoreNewData(pageNumber, rowsPerPage, studentType, Tabsvalue, datas);
    }
  }, [studentType, GetMoreNewData, datas]);
                    ...
                    >
                      ...
                      /> */}
                        ...
                        <div className="d-flex align-items-center justify-content-center">
                          <StudentlistuserEyeModal studentId={item?._id} studentInfo={item} studentType={studentType} tillDate={tillDate} />
                        </div>
                      </div>
                    </div>
                  );
