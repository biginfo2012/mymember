...
const MainRenewals = (props) => {
  ...
  const { rowdata,datas, GetMoreNewData, studentType, Tabsvalue, loading, tillDate } = props;
                    ...
                    >
                      <div className={classes.row}>
                        ...
                        <div className="d-flex align-items-center justify-content-center">
                          <StudentlistuserEyeModal studentId={item?._id} studentInfo={item} tillDate={tillDate} studentType={studentType} />
                        </div>
                      </div>
