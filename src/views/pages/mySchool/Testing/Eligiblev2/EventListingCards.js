        ...
        <Col sm={9} md={9} lg={9}>
          {fetchAllEvents?.length > 0 ? (
            fetchAllEvents?.map((item, i) => {
              return (
                <Card className="mb-2 p-1 p-sm-0" key={i}>
                  <Row className="">
                    <Col sm={4} md={4} lg={4}>
                    ...
                    <Col sm={4} md={4} lg={4} className="d-flex align-items-center w-100" >
                      <div className="w-100">
                        <div className="d-flex justify-content-center ">
                          <p className="mb-0 appointment_type" style={{ fontSize: "16px", color: "#656565", paddingBottom: "5px" }}>
                    ...
                    <Col xs={12} sm={2} md={2} lg={2} className="d-flex justify-content-center align-items-center">
