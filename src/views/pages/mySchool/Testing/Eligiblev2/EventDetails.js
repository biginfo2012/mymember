            ...
            <Row>
                        ...
                        <CardBody>
                            <Row>
                                ...
                                <Col md={8}>
                                    ...
                                    <CardSubtitle>
                                        {isReadMore ? selectedEvent?.notes?.slice(0, 120) : selectedEvent?.notes}
                                        {
                                            selectedEvent?.notes?.length > 120 && 
                                            <span onClick={handleReadMore} style={{color:"#2FA4FC"}}>
                ...
                <Col md={4}>
                    <Card>
                        ...
                        <div>
                            <h5 className="ml-1">Copy Link to Share</h5>
                            <div className="ml-1 mb-1">
                                <InputBase
                                    className="p-0 urlInput"
                                    style={{ width: "90%", border: "2px solid #0184ff", borderRadius: "4px", paddingLeft: "5px", fontSize: "12px" }}
                                    type="text"
                                ...
                                <Button
                                    ...
                                    size="small"
                                    onClick={() => {
                                        CopyPassWord(`${baseUrl}/public/events/${selectedEvent?._id}`);
                                    }}
                                >
                                    {pwCopy === (`${baseUrl}/public/events/${selectedEvent?._id}`) ? (
                                        <span style={{ fontSize: "0.8em" }}>Copied</span>
                                    ) : (
                                        <Copy style={{ color: "#2FA4FC", position:"absolute", bottom: "30", right: "10px" }} />
                                    )}
                                </Button>
                            </div>
                        </div>
