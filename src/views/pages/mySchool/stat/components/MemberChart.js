...
const StaticsbarChart = (props) => {
  ...
  const [ToolTipA, setToolTipA] = useState({});
  ...
  return (
    <div>
      <Row className="mt-2">
        <Col md="6">
          <div className="d-block d-sm-flex justify-content-between align-items-center stat-thead dark-back p-1">
          ...
          <div className="w-100 overflow-auto">
            {
              activeStatisticsType === "leadsStatics" ? <ResponsiveContainer height={300} width={500}>
                  <BarChart
                    width={500}
                    height={300}
                  ...
                  >
                    ...
                    <Bar barSize={8}
                         onMouseEnter={(e) => { showTooltip(e, "Joined") }}
                ...
                : <ResponsiveContainer height={300} width={500}>
                  ...
                  >
                    ...
                    <Bar
                      barSize={8}
                      onMouseEnter={(e) => { showTooltip(e, "Not Joined") }}
                      dataKey={(data) => data?.quite?.count} name="Not Joined" fill="#ff2929" />
                    <Bar
                      barSize={8}
                      onMouseEnter={(e) => { showTooltip(e, "Joined") }}
                      dataKey={(data) => data?.join?.count} name="Joined" fill="#0184FF" />
      ...
      <TableData />
      {
        ToolTipA?.show && <Dialog
          open={ToolTipA?.show}
          onClose={() => { setToolTipA({}) }}>
          <DialogContent>
            <CustomTooltip data={data} tooltip={tooltip} statisticsYear={statisticsYear} />
          </DialogContent>
        </Dialog>
      }
    </div >
