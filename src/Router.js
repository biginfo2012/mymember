...
const PageConnect = lazy(() =>
  import("./views/pages/marketing/socialmediamarketing/workspaceform/PageConnect")
)
...
const trash = lazy(() =>
  import("./views/pages/documents/components/Trash")
)
const support = lazy(() =>
...
const Reputation = lazy(() => import("./views/pages/marketing/Raputation/ReputationSideBar"))
const SocialMediaConnecting = lazy(() => import("./views/pages/marketing/socialmediamarketing/SocialMediaConnecting"))
const WorkSpace = lazy(() => import("./views/pages/marketing/socialmediamarketing/WorkSpace_components/WorkSpace"))
...
const formBuilderCreate = lazy(() => import("./views/formbuilder/pages/Create"))
const formBuilderCreateTemplate = lazy(() => import("./views/formbuilder/pages/CreateTemplateStepper"))
const formBuilderLayout = lazy(() => import("./views/formbuilder/pages/Chooselayout"))
...
const formBuilderPreView = lazy(() => import("./views/formbuilder/pages/preview"))
    ...
    return (
      ...
      <BrowserRouter history={history}>
        <Switch>
          ...
          />
          <AppRoute path="/calendar-new" component={calendarNew} />
          ...
          />
          <AppRoute path="/company/marketing/socialmedia" component={PageConnect} />
          <AppRoute path="/company/documenets/sharewithme" component={sharewithme} />
          ...
          <AppRoute path="/app/student/demo-table/list" component={DemoGetData} />
          ...
          <AppRoute path="/builder/template/create" component={formBuilderCreateTemplate} />
          <AppRoute path="/builder/template/view/:id" component={formBuilderCreateTemplate} />
          <AppRoute path="/builder/layout" component={formBuilderLayout} />
          <AppRoute path="/builder/home/:id" component={formBuilderHome} />
          <AppRoute path="/builder/view/:id/:userId" component={formBuilderView} fullLayout />
          <AppRoute path="/builder/preview" component={formBuilderPreView} fullLayout />
